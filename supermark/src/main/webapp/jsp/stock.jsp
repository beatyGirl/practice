...
<head>
    ...
    <link href="${pageContext.request.contextPath }/css/stock.css" rel="stylesheet" />
</head>
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            <h4>采购订货管理</h4>
            <div class="add" style="float:left;padding-right:10px"><a class="btn btn-success" onclick="">添加</a></div>
            <div class="add" style="float:left;padding-right:10px"><a class="btn btn-success" onclick="">修改</a></div>
            <div class="add" style="float:left;padding-right:10px"><a class="btn btn-success" onclick="">删除</a></div>
            <div class="w">
                <div class="span12">
